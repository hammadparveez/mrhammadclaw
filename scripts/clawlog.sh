...
show_usage() {
    cat << EOF
clawlog - MrHammadClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View MrHammadClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    MrHammadClaw logs flow through the macOS unified log (subsystem: ai.mrhammadclaw).
