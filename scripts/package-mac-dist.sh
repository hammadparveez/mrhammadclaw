...
#
# Output:
# - dist/MrHammadClaw.app
# - dist/MrHammadClaw-<version>.zip
# - dist/MrHammadClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.mrhammadclaw.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/MrHammadClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/MrHammadClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/MrHammadClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/MrHammadClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/MrHammadClaw-$VERSION.dSYM.zip"
