...
if [[ -z "$version_content" ]]; then
  echo "<h2>MrHammadClaw $VERSION</h2>"
  echo "<p>Latest MrHammadClaw update.</p>"
  echo "<p><a href=\"https://github.com/hammadparveez/mrhammadclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
