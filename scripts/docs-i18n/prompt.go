...
- Keep product names in English: MrHammadClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the MrHammadClaw Gateway, use “Gateway 网关”.
