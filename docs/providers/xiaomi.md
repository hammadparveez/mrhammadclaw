---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with MrHammadClaw"
read_when:
  - You want Xiaomi MiMo models in MrHammadClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). MrHammadClaw uses
