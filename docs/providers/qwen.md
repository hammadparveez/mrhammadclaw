---
summary: "Use Qwen OAuth (free tier) in MrHammadClaw"
read_when:
  - You want to use Qwen with MrHammadClaw
...
If you already logged in with the Qwen Code CLI, MrHammadClaw will sync credentials
