---
summary: "Use Qianfan's unified API to access many models in MrHammadClaw"
read_when:
...
3. MrHammadClaw installed on your system
...
4. Copy the API key for use with MrHammadClaw

## CLI setup

```bash
mrhammadclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [MrHammadClaw Configuration](/gateway/configuration)
