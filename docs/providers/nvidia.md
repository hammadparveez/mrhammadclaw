---
summary: "Use NVIDIA's OpenAI-compatible API in MrHammadClaw"
read_when:
  - You want to use NVIDIA models in MrHammadClaw
...
mrhammadclaw onboard --auth-choice skip
mrhammadclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
