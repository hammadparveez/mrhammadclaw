...
You can point MrHammadClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or MrHammadClaw
...
- [Anthropic provider](/providers/anthropic) - Native MrHammadClaw integration with Claude setup-token or API keys
