---
summary: "Use Synthetic's Anthropic-compatible API in MrHammadClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. MrHammadClaw registers it as the
...
Note: MrHammadClaw's Anthropic client appends `/v1` to the base URL, so use
