...
本指南总结了在 MrHammadClaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 MrHammadClaw 状态目录下。默认为 `~/.mrhammadclaw`。如果设置了 `MRHAMMADCLAW_STATE_DIR`，则使用该目录。

要重置所有内容：

- `mrhammadclaw.json` 用于配置
...
- https://docs.mrhammadclaw.ai/testing
- https://docs.mrhammadclaw.ai/start/getting-started
