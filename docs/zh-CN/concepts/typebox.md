...
- 生成的 Swift 模型：`apps/macos/Sources/MrHammadClawProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/mrhammadclaw/mrhammadclaw/main/dist/protocol.schema.json
