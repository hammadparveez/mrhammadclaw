...
read_when:
  ...
  - 你想设置默认工作区路径
summary: "`mrhammadclaw setup` 的 CLI 参考（初始化配置 + 工作区）"
title: setup
x-i18n:
...
初始化 `~/.mrhammadclaw/mrhammadclaw.json` 和智能体工作区。
...
```bash
mrhammadclaw setup
mrhammadclaw setup --workspace ~/.mrhammadclaw/workspace
```

通过 setup 运行向导：

```bash
mrhammadclaw setup --wizard
```
