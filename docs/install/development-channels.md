...
MrHammadClaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, MrHammadClaw also aligns
the install method:
...
When you switch channels with `mrhammadclaw update`, MrHammadClaw also syncs plugin sources:
