...
Deploy MrHammadClaw on Render using Infrastructure as Code. The included `render.yaml` Blueprint defines your entire stack declaratively, service, disk, environment variables, so you can deploy with a single click and version your infrastructure alongside your code.
...
[Deploy to Render](https://render.com/deploy?repo=https://github.com/hammadparveez/mrhammadclaw)
...
repository configures everything needed to run MrHammadClaw:
...
services:
  - type: web
    ...
    envVars:
      ...
      - key: MRHAMMADCLAW_STATE_DIR
        value: /data/.mrhammadclaw
      - key: MRHAMMADCLAW_WORKSPACE_DIR
        value: /data/workspace
      - key: MRHAMMADCLAW_GATEWAY_TOKEN
        generateValue: true # auto-generates a secure token
    disk:
      name: mrhammadclaw-data
      mountPath: /data
      sizeGB: 1
```
...
The web dashboard is available at `https://<your-service>.onrender.com/mrhammadclaw`.
...
If you use the original MrHammadClaw repository, Render will not auto-deploy your MrHammadClaw. To update it, run a manual Blueprint sync from the dashboard.
...
For MrHammadClaw, vertical scaling is usually sufficient. Horizontal scaling requires sticky sessions or external state management.
...
This downloads a portable backup you can restore on any MrHammadClaw host.
