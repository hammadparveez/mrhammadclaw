...
Deploy MrHammadClaw on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/mrhammadclaw` — Control UI
...
- `MRHAMMADCLAW_STATE_DIR=/data/.mrhammadclaw` (recommended)
- `MRHAMMADCLAW_WORKSPACE_DIR=/data/workspace` (recommended)
- `MRHAMMADCLAW_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your MrHammadClaw state + workspace so you can migrate to another host without losing config or memory.
