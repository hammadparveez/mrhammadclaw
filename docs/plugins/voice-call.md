...
read_when:
  - You want to place an outbound voice call from MrHammadClaw
...
Voice calls for MrHammadClaw via a plugin. Supports outbound notifications and
...
- Use `mrhammadclaw voicecall ...` or the `voice_call` tool
...
```bash
mrhammadclaw plugins install ./extensions/voice-call
