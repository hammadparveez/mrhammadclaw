...
read_when:
  - You are building a MrHammadClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (mrhammadclaw.plugin.json)

Every plugin **must** ship a `mrhammadclaw.plugin.json` file in the **plugin root**.
MrHammadClaw uses this manifest to validate configuration **without executing plugin
