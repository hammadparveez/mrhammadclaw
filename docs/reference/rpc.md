...
MrHammadClaw integrates external CLIs via JSON-RPC. Two patterns are used today.
...
- MrHammadClaw owns lifecycle when `channels.signal.autoStart=true`.
...
- MrHammadClaw spawns `imsg rpc` as a child process (legacy iMessage integration).
