---
summary: "Overview of MrHammadClaw onboarding options and flows"
read_when:
...
MrHammadClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`mrhammadclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the MrHammadClaw app when you want a fully guided setup on macOS. Docs:
