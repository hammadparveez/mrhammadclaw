...
read_when:
  - You want MrHammadClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables MrHammadClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`mrhammadclaw onboard`) and `mrhammadclaw channels add` list optional channel plugins.
...
```bash
mrhammadclaw plugins install @mrhammadclaw/nostr
```

Use a local checkout (dev workflows):

```bash
mrhammadclaw plugins install --link <path-to-mrhammadclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "mrhammadclaw",
        "displayName": "MrHammadClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "mrhammadclaw@example.com",
        "lud16": "mrhammadclaw@example.com"
      }
    }
  }
}
