...
- Install via CLI: `mrhammadclaw plugins install @mrhammadclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `mrhammadclaw plugins install ./extensions/zalo`
   - From npm (if published): `mrhammadclaw plugins install @mrhammadclaw/zalo`
...
- Approve via:
  - `mrhammadclaw pairing list zalo`
  - `mrhammadclaw pairing approve zalo <CODE>`
...
- Example: `mrhammadclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `mrhammadclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `mrhammadclaw logs --follow`
