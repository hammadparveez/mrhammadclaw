...
```bash
mrhammadclaw plugins install @mrhammadclaw/nextcloud-talk
```

Local checkout (when running from a git repo):

```bash
mrhammadclaw plugins install ./extensions/nextcloud-talk
```
...
2. On your Nextcloud server, create a bot:
   ...
   ```bash
   ./occ talk:bot:install "MrHammadClaw" "<shared-secret>" "<webhook-url>" --feature reaction
   ```
...
- Approve via:
  - `mrhammadclaw pairing list nextcloud-talk`
  - `mrhammadclaw pairing approve nextcloud-talk <CODE>`
