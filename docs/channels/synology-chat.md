---
summary: "Synology Chat webhook setup and MrHammadClaw config"
read_when:
  - Setting up Synology Chat with MrHammadClaw
...
```bash
mrhammadclaw plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your MrHammadClaw gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in MrHammadClaw.
...
- Pairing approvals work with:
  - `mrhammadclaw pairing list synology-chat`
  - `mrhammadclaw pairing approve synology-chat <CODE>`
...
```bash
mrhammadclaw message send --channel synology-chat --target 123456 --text "Hello from MrHammadClaw"
mrhammadclaw message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
