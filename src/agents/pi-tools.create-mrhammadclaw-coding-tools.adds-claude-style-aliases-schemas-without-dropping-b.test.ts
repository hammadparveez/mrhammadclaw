...
const defaultTools = createMrHammadClawCodingTools({ senderIsOwner: true });
...
describe("createMrHammadClawCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: MrHammadClawConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createMrHammadClawCodingTools({
    ...
    const anthropicTools = createMrHammadClawCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: MrHammadClawConfig = {
      tools: {
        exec: {
    ...
    const allowed = createMrHammadClawCodingTools({
    ...
    const denied = createMrHammadClawCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createMrHammadClawCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
