...
import { createMrHammadClawCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const agentDir = params.agentDir ?? resolveMrHammadClawAgentDir();
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/hammadparveez/mrhammadclaw/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt") {
          try {
            sessionManager.appendCustomEntry("mrhammadclaw:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/hammadparveez/mrhammadclaw/issues/8643
