...
const CLEANUP_STATE_KEY = Symbol.for("mrhammadclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("mrhammadclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("mrhammadclaw.sessionWriteLockWatchdogState");
