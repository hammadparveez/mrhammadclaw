...
type CoreToolDefinition = {
  ...
  includeInMrHammadClawGroup?: boolean;
};
...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  },
  {
    ...
    sectionId: "web",
    profiles: [],
    includeInMrHammadClawGroup: true,
  },
  {
    id: "web_fetch",
    label: "web_fetch",
...
function buildCoreToolGroupMap() {
  ...
  const mrhammadclawTools = CORE_TOOL_DEFINITIONS.filter(
    (tool) => tool.includeInMrHammadClawGroup,
  ).map((tool) => tool.id);
  return {
    "group:mrhammadclaw": mrhammadclawTools,
