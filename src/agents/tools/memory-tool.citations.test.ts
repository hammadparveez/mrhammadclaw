...
function asMrHammadClawConfig(config: Partial<MrHammadClawConfig>): MrHammadClawConfig {
  return config as MrHammadClawConfig;
}

function createToolConfig() {
  return asMrHammadClawConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: MrHammadClawConfig = createToolConfig()) {
...
describe("memory search citations", () => {
  it("appends source information when citations are enabled", async () => {
    ...
    const cfg = asMrHammadClawConfig({
      memory: { citations: "on" },
