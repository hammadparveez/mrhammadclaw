...
type WebSearchConfig = NonNullable<MrHammadClawConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: MrHammadClawConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("mrhammadclaw configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.mrhammadclaw.ai/tools/web",
  };
}
  ...
  return withTrustedWebSearchEndpoint(
    {
      ...
      init: {
        ...
        headers: {
          ...
          "HTTP-Referer": "https://mrhammadclaw.ai",
          "X-Title": "MrHammadClaw Web Search",
        },
