...
describe("gateway tool defaults", () => {
  const envSnapshot = {
    mrhammadclaw: process.env.MRHAMMADCLAW_GATEWAY_TOKEN,
  ...
  afterAll(() => {
    if (envSnapshot.mrhammadclaw === undefined) {
      delete process.env.MRHAMMADCLAW_GATEWAY_TOKEN;
    } else {
      process.env.MRHAMMADCLAW_GATEWAY_TOKEN = envSnapshot.mrhammadclaw;
    }
  ...
  it("uses MRHAMMADCLAW_GATEWAY_TOKEN for allowlisted local overrides", () => {
  ...
  it("does not leak local env/config tokens to remote overrides", () => {
    process.env.MRHAMMADCLAW_GATEWAY_TOKEN = "local-env-token";
