...
type MrHammadClawReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: MrHammadClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createMrHammadClawReadTool(base, {
...
export function createMrHammadClawReadTool(
  base: AnyAgentTool,
  options?: MrHammadClawReadToolOptions,
): AnyAgentTool {
