...
export const DEFAULT_SANDBOX_IMAGE = "mrhammadclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "mrhammadclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "mrhammadclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "mrhammadclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "mrhammadclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "mrhammadclaw-sandbox-browser";
