...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveMrHammadClawAgentDir() returns mainAgentDir
    process.env.MRHAMMADCLAW_STATE_DIR = tmpDir;
    process.env.MRHAMMADCLAW_AGENT_DIR = mainAgentDir;
