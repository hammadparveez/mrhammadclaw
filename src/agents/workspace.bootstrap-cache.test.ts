...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("mrhammadclaw-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("mrhammadclaw-cache-test1-");
    const workspace2 = await makeTempWorkspace("mrhammadclaw-cache-test2-");
