...
function resolveWatchPaths(workspaceDir: string, config?: MrHammadClawConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: MrHammadClawConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: MrHammadClawConfig }) {
