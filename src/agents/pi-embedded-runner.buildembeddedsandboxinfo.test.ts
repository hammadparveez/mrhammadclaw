...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/mrhammadclaw-sandbox",
    agentWorkspaceDir: "/tmp/mrhammadclaw-workspace",
    workspaceAccess: "none",
    containerName: "mrhammadclaw-sbx-test",
    ...
    browser: {
      ...
      containerName: "mrhammadclaw-sbx-browser-test",
    },
