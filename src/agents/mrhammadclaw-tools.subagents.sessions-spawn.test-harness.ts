...
export type CreateMrHammadClawToolsOpts = Parameters<CreateSessionsSpawnTool>[0];
...
export async function getSessionsSpawnTool(opts: CreateMrHammadClawToolsOpts) {
