...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@mrhammadclaw", { botUsername: "mrhammadclaw" })).toBe(
      "/help",
    );
    expect(
      normalizeCommandBody("/help@mrhammadclaw args", {
        botUsername: "mrhammadclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@mrhammadclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "mrhammadclaw" })).toBe(
      "/help@otherbot",
    );
  });
