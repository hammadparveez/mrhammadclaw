...
export async function prependSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: MrHammadClawConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: MrHammadClawConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.MRHAMMADCLAW_TEST_FAST === "1") {
