...
describe("stageSandboxMedia", () => {
  it("stages allowed media and blocks unsafe paths", async () => {
    await withSandboxMediaTempHome("mrhammadclaw-triggers-", async (home) => {
      const cfg = createSandboxMediaStageConfig(home);
      const workspaceDir = join(home, "mrhammadclaw");
      ...
      {
        const inboundDir = join(home, ".mrhammadclaw", "media", "inbound");
