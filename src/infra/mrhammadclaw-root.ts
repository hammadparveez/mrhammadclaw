...
const CORE_PACKAGE_NAMES = new Set(["mrhammadclaw", "mrhammadclaw"]);
...
export async function resolveMrHammadClawPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveMrHammadClawPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
