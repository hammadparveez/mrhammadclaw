...
export function applyMessageDefaults(cfg: MrHammadClawConfig): MrHammadClawConfig {
...
export function applyTalkApiKey(config: MrHammadClawConfig): MrHammadClawConfig {
...
export function applyTalkConfigNormalization(config: MrHammadClawConfig): MrHammadClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: MrHammadClawConfig): MrHammadClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: MrHammadClawConfig): MrHammadClawConfig {
...
export function applyLoggingDefaults(cfg: MrHammadClawConfig): MrHammadClawConfig {
...
export function applyContextPruningDefaults(cfg: MrHammadClawConfig): MrHammadClawConfig {
...
export function applyCompactionDefaults(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
