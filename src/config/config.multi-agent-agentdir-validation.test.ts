...
describe("multi-agent agentDir validation", () => {
  it("rejects shared agents.list agentDir", async () => {
    const shared = path.join(tmpdir(), "mrhammadclaw-shared-agentdir");
    ...
    await withTempHomeConfig(
      {
        agents: {
          list: [
            { id: "a", agentDir: "~/.mrhammadclaw/agents/shared/agent" },
            { id: "b", agentDir: "~/.mrhammadclaw/agents/shared/agent" },
          ],
        },
