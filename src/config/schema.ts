...
export type ConfigSchema = ReturnType<typeof MrHammadClawSchema.toJSONSchema>;
...
function buildBaseConfigSchema(): ConfigSchemaResponse {
  ...
  const hints = applyDerivedTags(mapSensitivePaths(MrHammadClawSchema, "", buildBaseHints()));
  const next = {
