...
export const normalizePluginsConfig = (
  config?: MrHammadClawConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: MrHammadClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: MrHammadClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: MrHammadClawConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
