...
export type MrHammadClawPluginConfigSchema = {
...
export type MrHammadClawPluginToolContext = {
...
export type MrHammadClawPluginToolFactory = (
  ctx: MrHammadClawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type MrHammadClawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type MrHammadClawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<MrHammadClawConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type MrHammadClawPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current MrHammadClaw configuration */
  config: MrHammadClawConfig;
 ...
 */
export type MrHammadClawPluginCommandDefinition = {
...
export type MrHammadClawPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type MrHammadClawPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type MrHammadClawPluginCliContext = {
  program: Command;
  config: MrHammadClawConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type MrHammadClawPluginCliRegistrar = (
  ctx: MrHammadClawPluginCliContext,
) => void | Promise<void>;

export type MrHammadClawPluginServiceContext = {
  config: MrHammadClawConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type MrHammadClawPluginService = {
  id: string;
  start: (ctx: MrHammadClawPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: MrHammadClawPluginServiceContext) => void | Promise<void>;
};

export type MrHammadClawPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type MrHammadClawPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: MrHammadClawPluginConfigSchema;
  register?: (api: MrHammadClawPluginApi) => void | Promise<void>;
  activate?: (api: MrHammadClawPluginApi) => void | Promise<void>;
};

export type MrHammadClawPluginModule =
  | MrHammadClawPluginDefinition
  | ((api: MrHammadClawPluginApi) => void | Promise<void>);

export type MrHammadClawPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | MrHammadClawPluginToolFactory,
    opts?: MrHammadClawPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: MrHammadClawPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: MrHammadClawPluginHttpHandler) => void;
  registerHttpRoute: (params: {
    path: string;
    handler: MrHammadClawPluginHttpRouteHandler;
  }) => void;
  registerChannel: (registration: MrHammadClawPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: MrHammadClawPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: MrHammadClawPluginService) => void;
   ...
   */
  registerCommand: (command: MrHammadClawPluginCommandDefinition) => void;
