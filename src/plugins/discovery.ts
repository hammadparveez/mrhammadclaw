...
import {
  ...
  type MrHammadClawPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @mrhammadclaw/voice-call -> voice-call).
...
export function discoverMrHammadClawPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".mrhammadclaw", "extensions")];
