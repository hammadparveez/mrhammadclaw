...
export const PLUGIN_MANIFEST_FILENAME = "mrhammadclaw.plugin.json";
...
// package.json "mrhammadclaw" metadata (used for onboarding/catalog)
...
export type MrHammadClawPackageManifest = {
  extensions?: string[];
...
): MrHammadClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
