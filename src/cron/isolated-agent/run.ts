...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/hammadparveez/mrhammadclaw/issues/15692
   */
  delivered?: boolean;
  /**
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.MRHAMMADCLAW_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.mrhammadclaw/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: MrHammadClawConfig = {
    ...params.cfg,
