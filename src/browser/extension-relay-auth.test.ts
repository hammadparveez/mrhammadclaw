...
import {
  probeAuthenticatedMrHammadClawRelay,
...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated mrhammadclaw relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedMrHammadClawRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-mrhammadclaw-relay-token",
