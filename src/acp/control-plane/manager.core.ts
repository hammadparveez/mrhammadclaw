...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: MrHammadClawConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: MrHammadClawConfig): AcpManagerObservabilitySnapshot {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: MrHammadClawConfig }): Promise<void> {
