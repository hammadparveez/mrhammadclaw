...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.MRHAMMADCLAW_TTS_PREFS;
      process.env.MRHAMMADCLAW_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.MRHAMMADCLAW_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: MrHammadClawConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
