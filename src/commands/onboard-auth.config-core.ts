...
export function applyOpenrouterProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: MrHammadClawConfig): MrHammadClawConfig {
...
export function applyMoonshotConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
...
export function applyQianfanProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
