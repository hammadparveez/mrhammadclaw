...
export function applyOpencodeZenProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
...
export function applyOpencodeZenConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
