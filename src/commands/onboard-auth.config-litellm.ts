...
export function applyLitellmProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
...
export function applyLitellmConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
