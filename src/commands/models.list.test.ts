...
const ensureMrHammadClawModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveMrHammadClawAgentDir = vi.fn().mockReturnValue("/tmp/mrhammadclaw-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/mrhammadclaw-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureMrHammadClawModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveMrHammadClawAgentDir,
}));
