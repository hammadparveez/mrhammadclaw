...
export function applyVercelAiGatewayProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
...
export function applyVercelAiGatewayConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
