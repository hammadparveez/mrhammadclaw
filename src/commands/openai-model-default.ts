...
export function applyOpenAIProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
...
export function applyOpenAIConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
