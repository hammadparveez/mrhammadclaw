...
function resolveDefaultAccountId(cfg: MrHammadClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: MrHammadClawConfig): boolean {
...
export function summarizeBindings(cfg: MrHammadClawConfig, bindings: AgentBinding[]): string[] {
