...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.mrhammadclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("mrhammadclaw hooks list")}`,
      `  ${formatCliCommand("mrhammadclaw hooks enable <name>")}`,
      `  ${formatCliCommand("mrhammadclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
