...
export function summarizeExistingConfig(config: MrHammadClawConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.mrhammadclaw.ai/gateway/remote",
    "https://docs.mrhammadclaw.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
