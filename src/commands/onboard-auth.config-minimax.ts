...
export function applyMinimaxProviderConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
...
export function applyMinimaxConfig(cfg: MrHammadClawConfig): MrHammadClawConfig {
