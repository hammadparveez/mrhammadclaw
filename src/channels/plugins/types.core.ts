...
export type ChannelAgentToolFactory = (params: { cfg?: MrHammadClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: MrHammadClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: MrHammadClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: MrHammadClawConfig }) => boolean;
  supportsCards?: (params: { cfg: MrHammadClawConfig }) => boolean;
