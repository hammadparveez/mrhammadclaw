...
import { discoverMrHammadClawPlugins } from "../../plugins/discovery.js";
import type { MrHammadClawPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, MrHammadClawPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["MRHAMMADCLAW_PLUGIN_CATALOG_PATHS", "MRHAMMADCLAW_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<MrHammadClawPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: MrHammadClawPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: MrHammadClawPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverMrHammadClawPlugins({ workspaceDir: options.workspaceDir });
