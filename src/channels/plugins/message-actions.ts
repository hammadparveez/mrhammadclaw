...
export function listChannelMessageActions(cfg: MrHammadClawConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: MrHammadClawConfig): boolean {
...
export function supportsChannelMessageCards(cfg: MrHammadClawConfig): boolean {
