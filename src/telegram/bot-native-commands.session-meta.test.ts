...
function registerAndResolveStatusHandler(cfg: MrHammadClawConfig): TelegramCommandHandler {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/mrhammadclaw-sessions.json");
