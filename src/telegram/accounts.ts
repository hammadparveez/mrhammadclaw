...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.MRHAMMADCLAW_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: MrHammadClawConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: MrHammadClawConfig): string {
...
export function listEnabledTelegramAccounts(cfg: MrHammadClawConfig): ResolvedTelegramAccount[] {
