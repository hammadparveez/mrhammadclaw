...
type SecretDefaults = NonNullable<MrHammadClawConfig["secrets"]>["defaults"];
...
function collectCandidateAgentDirs(config: MrHammadClawConfig): string[] {
  const dirs = new Set<string>();
  dirs.add(resolveUserPath(resolveMrHammadClawAgentDir()));
