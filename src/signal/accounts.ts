...
function mergeSignalAccountConfig(cfg: MrHammadClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: MrHammadClawConfig): ResolvedSignalAccount[] {
