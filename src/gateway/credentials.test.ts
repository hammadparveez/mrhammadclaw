...
function cfg(input: Partial<MrHammadClawConfig>): MrHammadClawConfig {
  return input as MrHammadClawConfig;
}

type ResolveFromConfigInput = Parameters<typeof resolveGatewayCredentialsFromConfig>[0];
type GatewayConfig = NonNullable<MrHammadClawConfig["gateway"]>;
