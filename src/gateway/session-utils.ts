...
import { type MrHammadClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: MrHammadClawConfig): string[] {
...
export function listAgentsForGateway(cfg: MrHammadClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: MrHammadClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: MrHammadClawConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: MrHammadClawConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: MrHammadClawConfig): GatewaySessionsDefaults {
