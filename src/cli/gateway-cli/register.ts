      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["mrhammadclaw gateway run", "Run the gateway in the foreground."],
            ["mrhammadclaw gateway status", "Show service status and probe reachability."],
            ["mrhammadclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["mrhammadclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.mrhammadclaw.ai/cli/gateway")}\n`,
      ),
  );
