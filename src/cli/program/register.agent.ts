...
${formatHelpExamples([
  ['mrhammadclaw agent --to +15555550123 --message "status update"', "Start a new session."],
  ['mrhammadclaw agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'mrhammadclaw agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'mrhammadclaw agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['mrhammadclaw agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'mrhammadclaw agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
    "Send reply to a different channel/target.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.mrhammadclaw.ai/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.mrhammadclaw.ai/cli/agents")}\n`,
    );
...
${formatHelpExamples([
  [
    'mrhammadclaw agents set-identity --agent main --name "MrHammadClaw" --emoji "🦞"',
    "Set name + emoji.",
  ],
  [
  ...
  [
    "mrhammadclaw agents set-identity --identity-file ~/.mrhammadclaw/workspace/IDENTITY.md --agent main",
