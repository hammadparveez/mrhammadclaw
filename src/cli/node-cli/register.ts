    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          [
            "mrhammadclaw node run --host 127.0.0.1 --port 18789",
            "Run the node host in the foreground.",
          ],
          ["mrhammadclaw node status", "Check node host service status."],
          ["mrhammadclaw node install", "Install the node host service."],
          ["mrhammadclaw node restart", "Restart the installed node host service."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/node", "docs.mrhammadclaw.ai/cli/node")}\n`,
    );
