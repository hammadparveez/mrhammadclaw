...
async function runBrowserToggle(
  ...
  const name = status.profile ?? "mrhammadclaw";
...
export function registerBrowserManageCommands(
  ...
  browser
    ...
    .action(async (_opts, cmd) => {
      ...
      await runBrowserCommand(async () => {
        ...
        defaultRuntime.log(
          [
            `profile: ${status.profile ?? "mrhammadclaw"}`,
  ...
  browser
    ...
    .option("--driver <driver>", "Profile driver (mrhammadclaw|extension). Default: mrhammadclaw")
    .action(
