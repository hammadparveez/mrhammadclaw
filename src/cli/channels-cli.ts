    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mrhammadclaw channels list", "List configured channels and auth profiles."],
          ["mrhammadclaw channels status --probe", "Run channel status checks and probes."],
          [
            "mrhammadclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["mrhammadclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.mrhammadclaw.ai/cli/channels",
        )}\n`,
    );
