...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "<paths...>",
      "File paths to upload (must be within MrHammadClaw temp uploads dir, e.g. /tmp/mrhammadclaw/uploads/file.pdf)",
    )
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within mrhammadclaw temp downloads dir (default: /tmp/mrhammadclaw/downloads/...; fallback: os.tmpdir()/mrhammadclaw/downloads/...)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within mrhammadclaw temp downloads dir (e.g. report.pdf or /tmp/mrhammadclaw/downloads/report.pdf)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
