...
export const DEFAULT_CLI_NAME = "mrhammadclaw";

const KNOWN_CLI_NAMES = new Set(["mrhammadclaw", "mrhammadclaw"]);
const CLI_PREFIX_RE = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(mrhammadclaw|mrhammadclaw)\b/;
