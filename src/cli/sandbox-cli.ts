...
const SANDBOX_EXAMPLES = {
  main: [
    ["mrhammadclaw sandbox list", "List all sandbox containers."],
    ["mrhammadclaw sandbox list --browser", "List only browser containers."],
    ["mrhammadclaw sandbox recreate --all", "Recreate all containers."],
    ["mrhammadclaw sandbox recreate --session main", "Recreate a specific session."],
    ["mrhammadclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["mrhammadclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["mrhammadclaw sandbox list", "List all sandbox containers."],
    ["mrhammadclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ...
    ["mrhammadclaw sandbox recreate --session main", "Recreate a specific session."],
    [
      "mrhammadclaw sandbox recreate --agent mybot",
      "Recreate a specific agent (includes sub-agents).",
    ],
    ["mrhammadclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["mrhammadclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["mrhammadclaw sandbox explain", "Show effective sandbox config."],
    ["mrhammadclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["mrhammadclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["mrhammadclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.mrhammadclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
