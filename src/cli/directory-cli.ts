    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mrhammadclaw directory self --channel slack", "Show the connected account identity."],
          [
            'mrhammadclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          [
            "mrhammadclaw directory groups list --channel discord",
            "List available groups/channels.",
          ],
          [
            "mrhammadclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.mrhammadclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
