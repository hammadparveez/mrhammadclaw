...
export function listBindings(cfg: MrHammadClawConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: MrHammadClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: MrHammadClawConfig) {
