...
function resolveGatewayPort(cfg: MrHammadClawConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: MrHammadClawConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.MRHAMMADCLAW_GATEWAY_PASSWORD?.trim() ||
