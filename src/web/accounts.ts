...
export function listWhatsAppAuthDirs(cfg: MrHammadClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: MrHammadClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: MrHammadClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: MrHammadClawConfig): ResolvedWhatsAppAccount[] {
