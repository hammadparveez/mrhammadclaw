...
declare const __MRHAMMADCLAW_VERSION__: string | undefined;
const CORE_PACKAGE_NAME = "mrhammadclaw";
...
export function resolveRuntimeServiceVersion(
  ...
  return (
    firstNonEmpty(
      env["MRHAMMADCLAW_VERSION"],
      env["MRHAMMADCLAW_SERVICE_VERSION"],
      env["npm_package_version"],
    ) ?? fallback
  );
}

// Single source of truth for the current MrHammadClaw version.
// - Embedded/bundled builds: injected define or env var.
// - Dev/npm builds: package.json.
export const VERSION =
  (typeof __MRHAMMADCLAW_VERSION__ === "string" && __MRHAMMADCLAW_VERSION__) ||
  process.env.MRHAMMADCLAW_BUNDLED_VERSION ||
