...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: MrHammadClawConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: MrHammadClawConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__mrhammadclawMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__mrhammadclawMcporterColdStartWarned;
  });
