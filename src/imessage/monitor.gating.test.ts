...
function baseCfg(): MrHammadClawConfig {
  return {
    channels: {
      imessage: {
        dmPolicy: "open",
  ...
  it("blocks group messages when imessage.groups is set without a wildcard", () => {
    ...
    const decision = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550001111",
        is_from_me: false,
        text: "@mrhammadclaw hello",
        is_group: true,
      },
      opts: {},
      messageText: "@mrhammadclaw hello",
      bodyText: "@mrhammadclaw hello",
      allowFrom: ["*"],
      groupAllowFrom: [],
      groupPolicy: "open",
      dmPolicy: "open",
  ...
  it("honors group allowlist and ignores pairing-store senders in groups", () => {
    ...
    const denied = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@mrhammadclaw hi",
        is_group: true,
      },
      opts: {},
      messageText: "@mrhammadclaw hi",
      bodyText: "@mrhammadclaw hi",
      allowFrom: ["*"],
    ...
    const allowed = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@mrhammadclaw ok",
        is_group: true,
      },
      opts: {},
      messageText: "@mrhammadclaw ok",
      bodyText: "@mrhammadclaw ok",
      allowFrom: ["*"],
      groupAllowFrom: ["chat_id:101"],
      groupPolicy: "allowlist",
      dmPolicy: "pairing",
