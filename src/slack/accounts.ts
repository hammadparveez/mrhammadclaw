...
function mergeSlackAccountConfig(cfg: MrHammadClawConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: MrHammadClawConfig): ResolvedSlackAccount[] {
