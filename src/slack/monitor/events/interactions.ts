...
// Prefix for MrHammadClaw-generated action IDs to scope our handler
const MRHAMMADCLAW_ACTION_PREFIX = "mrhammadclaw:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${MRHAMMADCLAW_ACTION_PREFIX}`);

  // Handle MrHammadClaw modal submissions with callback_ids scoped by our prefix.
