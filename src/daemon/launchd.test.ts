...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.mrhammadclaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", MRHAMMADCLAW_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.mrhammadclaw.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.mrhammadclaw.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when MRHAMMADCLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.mrhammadclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when MRHAMMADCLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", MRHAMMADCLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.mrhammadclaw.jbphoenix.plist",
    },
    {
      name: "prefers MRHAMMADCLAW_LAUNCHD_LABEL over MRHAMMADCLAW_PROFILE",
      env: {
        HOME: "/Users/test",
        MRHAMMADCLAW_PROFILE: "jbphoenix",
        MRHAMMADCLAW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from MRHAMMADCLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        MRHAMMADCLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty MRHAMMADCLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        MRHAMMADCLAW_PROFILE: "myprofile",
        MRHAMMADCLAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.mrhammadclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
