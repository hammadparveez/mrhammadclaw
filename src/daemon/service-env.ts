...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.MRHAMMADCLAW_STATE_DIR;
  const configPath = env.MRHAMMADCLAW_CONFIG_PATH;
  ...
  return {
    ...
    ...proxyEnv,
    MRHAMMADCLAW_PROFILE: profile,
    MRHAMMADCLAW_STATE_DIR: stateDir,
    MRHAMMADCLAW_CONFIG_PATH: configPath,
    MRHAMMADCLAW_GATEWAY_PORT: String(port),
    MRHAMMADCLAW_GATEWAY_TOKEN: token,
    MRHAMMADCLAW_LAUNCHD_LABEL: resolvedLaunchdLabel,
    MRHAMMADCLAW_SYSTEMD_UNIT: systemdUnit,
    MRHAMMADCLAW_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    MRHAMMADCLAW_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    MRHAMMADCLAW_STATE_DIR: stateDir,
    MRHAMMADCLAW_CONFIG_PATH: configPath,
    MRHAMMADCLAW_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    MRHAMMADCLAW_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    MRHAMMADCLAW_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    MRHAMMADCLAW_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    MRHAMMADCLAW_LOG_PREFIX: "node",
    MRHAMMADCLAW_SERVICE_MARKER: NODE_SERVICE_MARKER,
    MRHAMMADCLAW_SERVICE_KIND: NODE_SERVICE_KIND,
    MRHAMMADCLAW_SERVICE_VERSION: VERSION,
  };
}
