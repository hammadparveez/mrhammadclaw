...
export async function handleNextcloudTalkInbound(params: {
  ...
  const defaultGroupPolicy = resolveDefaultGroupPolicy(config as MrHammadClawConfig);
  ...
  const allowTextCommands = core.channel.commands.shouldHandleTextCommands({
    cfg: config as MrHammadClawConfig,
    surface: CHANNEL_ID,
  });
  ...
  const mentionRegexes = core.channel.mentions.buildMentionRegexes(config as MrHammadClawConfig);
