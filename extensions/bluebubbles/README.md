...
This directory contains the **BlueBubbles external channel plugin** for MrHammadClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `mrhammadclaw/plugin-sdk` helpers.
