...
import { resolveChannelMediaMaxBytes, type MrHammadClawConfig } from "mrhammadclaw/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: MrHammadClawConfig; accountId?: string }): string[] {
