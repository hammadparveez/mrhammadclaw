...
export function listBlueBubblesAccountIds(cfg: MrHammadClawConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: MrHammadClawConfig): string {
