...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "mrhammadclaw/plugin-sdk";
...
import { resolvePreferredMrHammadClawTmpDir } from "../../../src/infra/tmp-mrhammadclaw-dir.js";
import {
  type MSTeamsAdapter,
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(
        path.join(resolvePreferredMrHammadClawTmpDir(), "msteams-mention-"),
      );
