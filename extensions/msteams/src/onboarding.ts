...
function setMSTeamsDmPolicy(cfg: MrHammadClawConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: MrHammadClawConfig, allowFrom: string[]): MrHammadClawConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
