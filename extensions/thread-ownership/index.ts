import type { MrHammadClawConfig, MrHammadClawPluginApi } from "mrhammadclaw/plugin-sdk";
...
function resolveOwnershipAgent(config: MrHammadClawConfig): { id: string; name: string } {
