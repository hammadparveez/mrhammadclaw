...
Nostr DM channel plugin for MrHammadClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to MrHammadClaw. It enables your bot to:
...
# Configure mrhammadclaw to use local relay
