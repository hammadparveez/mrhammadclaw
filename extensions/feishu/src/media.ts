...
import { withTempDownloadPath, type ClawdbotConfig } from "mrhammadclaw/plugin-sdk";
...
export async function downloadImageFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "mrhammadclaw-feishu-img-",
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "mrhammadclaw-feishu-resource-",
