...
import type { ReplyPayload, MrHammadClawConfig } from "mrhammadclaw/plugin-sdk";
import { createReplyPrefixOptions } from "mrhammadclaw/plugin-sdk";
...
export type TwitchMonitorOptions = {
  ...
  accountId: string;
  config: unknown; // MrHammadClawConfig
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as MrHammadClawConfig;
