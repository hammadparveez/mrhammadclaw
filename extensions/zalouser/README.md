...
MrHammadClaw extension for Zalo Personal Account messaging via [zca-cli](https://zca-cli.dev).
...
```bash
mrhammadclaw channels login --channel zalouser
...
```bash
mrhammadclaw message send --channel zalouser --target <threadId> --message "Hello from MrHammadClaw!"
```
...
```bash
mrhammadclaw channels login --channel zalouser              # Login via QR
mrhammadclaw channels login --channel zalouser --account work
mrhammadclaw channels status --probe
mrhammadclaw channels logout --channel zalouser
```

### Directory (IDs, contacts, groups)

```bash
mrhammadclaw directory self --channel zalouser
mrhammadclaw directory peers list --channel zalouser --query "name"
mrhammadclaw directory groups list --channel zalouser --query "work"
mrhammadclaw directory groups members --channel zalouser --group-id <id>
```
...
```bash
# Text
mrhammadclaw message send --channel zalouser --target <threadId> --message "message"

# Media (URL)
mrhammadclaw message send --channel zalouser --target <threadId> --message "caption" --media-url "https://example.com/img.jpg"
```

### Listener

The listener runs inside the Gateway when the channel is enabled. For debugging,
use `mrhammadclaw channels logs --channel zalouser` or run `zca listen` directly.
...
```bash
mrhammadclaw channels login --channel zalouser --account work
mrhammadclaw message send --channel zalouser --account work --target <id> --message "Hello"
