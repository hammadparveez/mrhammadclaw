...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "mrhammadclaw-control-ui",
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as MrHammadClawApp);
      void loadAgents(host as unknown as MrHammadClawApp);
      void loadToolsCatalog(host as unknown as MrHammadClawApp);
      void loadNodes(host as unknown as MrHammadClawApp, { quiet: true });
      void loadDevices(host as unknown as MrHammadClawApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (state === "final") {
    void loadSessions(host as unknown as MrHammadClawApp, {
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as MrHammadClawApp, payload);
  handleTerminalChatEvent(host, payload, state);
  if (state === "final" && shouldReloadHistoryForFinalEvent(payload)) {
    void loadChatHistory(host as unknown as MrHammadClawApp);
  }
}
