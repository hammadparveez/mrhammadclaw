...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.mrhammadclaw/mrhammadclaw.json com segurança.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando mrhammadclaw dashboard --no-open no desktop.",
    },
    insecure: {
