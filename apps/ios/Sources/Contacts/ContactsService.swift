...
final class ContactsService: ContactsServicing {
    ...
    func search(params: MrHammadClawContactsSearchParams) async throws -> MrHammadClawContactsSearchPayload {
        ...
        return MrHammadClawContactsSearchPayload(contacts: payload)
    }
    ...
    func add(params: MrHammadClawContactsAddParams) async throws -> MrHammadClawContactsAddPayload {
        ...
        if !phoneNumbers.isEmpty || !emails.isEmpty {
            if let existing = try Self.findExistingContact(
                ...
                emails: emails)
            {
                return MrHammadClawContactsAddPayload(contact: Self.payload(from: existing))
            }
        }
        ...
        return MrHammadClawContactsAddPayload(contact: Self.payload(from: persisted))
    }
    ...
    private static func payload(from contact: CNContact) -> MrHammadClawContactPayload {
        MrHammadClawContactPayload(
