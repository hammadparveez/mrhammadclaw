...
@MainActor
final class MrHammadClawAppDelegate: NSObject, UIApplicationDelegate, @preconcurrency UNUserNotificationCenterDelegate {
    private let logger = Logger(subsystem: "ai.mrhammadclaw.ios", category: "Push")
    private let backgroundWakeLogger = Logger(subsystem: "ai.mrhammadclaw.ios", category: "BackgroundWake")
    private static let wakeRefreshTaskIdentifier = "ai.mrhammadclaw.ios.bgrefresh"
...
enum WatchPromptNotificationBridge {
    static let typeKey = "mrhammadclaw.type"
    static let typeValue = "watch.prompt"
    static let promptIDKey = "mrhammadclaw.watch.promptId"
    static let sessionKeyKey = "mrhammadclaw.watch.sessionKey"
    static let actionPrimaryIDKey = "mrhammadclaw.watch.action.primary.id"
    static let actionPrimaryLabelKey = "mrhammadclaw.watch.action.primary.label"
    static let actionSecondaryIDKey = "mrhammadclaw.watch.action.secondary.id"
    static let actionSecondaryLabelKey = "mrhammadclaw.watch.action.secondary.label"
    static let actionPrimaryIdentifier = "mrhammadclaw.watch.action.primary"
    static let actionSecondaryIdentifier = "mrhammadclaw.watch.action.secondary"
    static let actionIdentifierPrefix = "mrhammadclaw.watch.action."
    static let actionIDKeyPrefix = "mrhammadclaw.watch.action.id."
    static let actionLabelKeyPrefix = "mrhammadclaw.watch.action.label."
    static let categoryPrefix = "mrhammadclaw.watch.prompt.category."

    @MainActor
    static func scheduleMirroredWatchPromptNotificationIfNeeded(
        invokeID: String,
        params: MrHammadClawWatchNotifyParams,
        sendResult: WatchNotificationSendResult) async
    {
        ...
        let normalizedActions = (params.actions ?? []).compactMap { action -> MrHammadClawWatchAction? in
            let id = action.id.trimmingCharacters(in: .whitespacesAndNewlines)
            let label = action.label.trimmingCharacters(in: .whitespacesAndNewlines)
            guard !id.isEmpty, !label.isEmpty else { return nil }
            return MrHammadClawWatchAction(id: id, label: label, style: action.style)
        }
        ...
        content.title = title.isEmpty ? "MrHammadClaw" : title
        content.body = body
    ...
    private static func categoryActions(_ actions: [MrHammadClawWatchAction]) -> [UNNotificationAction] {
...
@main
struct MrHammadClawApp: App {
    @State private var appModel: NodeAppModel
    @State private var gatewayController: GatewayConnectionController
    @UIApplicationDelegateAdaptor(MrHammadClawAppDelegate.self) private var appDelegate
...
extension MrHammadClawApp {
    private static func installUncaughtExceptionLogger() {
        NSLog("MrHammadClaw: installing uncaught exception handler")
