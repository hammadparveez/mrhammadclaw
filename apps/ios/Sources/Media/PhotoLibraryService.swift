...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: MrHammadClawPhotosLatestParams) async throws -> MrHammadClawPhotosLatestPayload {
        ...
        var results: [MrHammadClawPhotoPayload] = []
        ...
        return MrHammadClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> MrHammadClawPhotoPayload
    {
        ...
        return MrHammadClawPhotoPayload(
            format: "jpeg",
