...
actor CameraController {
    ...
    func snap(params: MrHammadClawCameraSnapParams) async throws -> (
        format: String,
        base64: String,
        width: Int,
        height: Int)
    ...
    func clip(params: MrHammadClawCameraClipParams) async throws -> (
        format: String,
        base64: String,
        durationMs: Int,
        hasAudio: Bool)
    {
        ...
        let movURL = FileManager().temporaryDirectory
            .appendingPathComponent("mrhammadclaw-camera-\(UUID().uuidString).mov")
        let mp4URL = FileManager().temporaryDirectory
            .appendingPathComponent("mrhammadclaw-camera-\(UUID().uuidString).mp4")
    ...
    private nonisolated static func pickCamera(
        facing: MrHammadClawCameraFacing,
