...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.mrhammadclaw.gateway"
    private static let nodeService = "ai.mrhammadclaw.node"
    private static let talkService = "ai.mrhammadclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.mrhammadclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.mrhammadclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("mrhammadclaw-gateway.log")
    }
