...
enum UIStrings {
    static let welcomeTitle = "Welcome to MrHammadClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "mrhammadclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: MrHammadClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g mrhammadclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: MrHammadClawChatViewModel(
