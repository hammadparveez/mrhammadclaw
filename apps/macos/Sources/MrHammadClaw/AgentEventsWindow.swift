...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: MrHammadClawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": MrHammadClawProtocol.AnyCodable("start"),
                "name": MrHammadClawProtocol.AnyCodable("bash"),
            ],
            summary: nil)
