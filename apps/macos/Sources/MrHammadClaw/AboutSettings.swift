...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/hammadparveez/mrhammadclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/hammadparveez/mrhammadclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://mrhammadclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "MrHammadClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MrHammadClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "MrHammadClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MrHammadClawGitCommit") as? String) ??
            "unknown"
    }
