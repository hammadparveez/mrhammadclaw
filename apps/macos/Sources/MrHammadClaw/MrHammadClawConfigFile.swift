...
enum MrHammadClawConfigFile {
    private static let logger = Logger(subsystem: "ai.mrhammadclaw", category: "config")
    ...
    static func stateDirURL() -> URL {
        MrHammadClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        MrHammadClawPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-mrhammadclaw-config-file",
            "event": "config.write",
