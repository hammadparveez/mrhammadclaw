...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = MrHammadClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = MrHammadClawConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = MrHammadClawConfigFile.loadDict()
            ...
            MrHammadClawConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/mrhammadclaw"
        state.remoteCliPath = ""
        return state
    }
}
