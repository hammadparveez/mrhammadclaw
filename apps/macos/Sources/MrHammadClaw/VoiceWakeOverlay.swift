...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.mrhammadclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other MrHammadClaw windows, but below the system’s pop-up menus.
