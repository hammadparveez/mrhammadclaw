...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.mrhammadclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.mrhammadclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [MrHammadClawChatMessage] = messages.compactMap { item in
