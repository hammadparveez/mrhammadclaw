...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .mrhammadclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? MrHammadClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? MrHammadClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let mrhammadclawSelectSettingsTab = Notification.Name("mrhammadclawSelectSettingsTab")
}
