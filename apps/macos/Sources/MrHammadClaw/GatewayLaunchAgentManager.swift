...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.mrhammadclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".mrhammadclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.mrhammadclawCommand(
            subcommand: "gateway",
