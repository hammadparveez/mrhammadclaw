...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "ai.mrhammadclaw", category: "PeekabooBridge")

    private var host: PeekabooBridgeHost?
    private var services: MrHammadClawPeekabooBridgeServices?
    private static var mrhammadclawSocketPath: String {
        let fileManager = FileManager.default
        let base = fileManager.urls(for: .applicationSupportDirectory, in: .userDomainMask).first
            ?? fileManager.homeDirectoryForCurrentUser.appendingPathComponent("Library/Application Support")
        let directory = base.appendingPathComponent("MrHammadClaw", isDirectory: true)
    ...
    private func startIfNeeded() async {
        ...
        let services = MrHammadClawPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: Self.mrhammadclawSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(Self.mrhammadclawSocketPath, privacy: .public)")
    }
...
@MainActor
private final class MrHammadClawPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "ai.mrhammadclaw.peekaboo")
