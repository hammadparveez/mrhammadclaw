...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.mrhammadclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("MrHammadClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__mrhammadclaw__/a2ui/").absoluteString + "?platform=macos"
    }
