...
@Suite struct InstancesStoreTests {
    ...
    func presenceEventPayloadDecodesViaJSONEncoder() {
        ...
        let entry: [String: MrHammadClawProtocol.AnyCodable] = [
            "host": .init("gw"),
            "ip": .init("10.0.0.1"),
            "version": .init("2.0.0"),
            "mode": .init("gateway"),
        ...
        let payloadMap: [String: MrHammadClawProtocol.AnyCodable] = [
            "presence": .init([MrHammadClawProtocol.AnyCodable(entry)]),
        ]
        let payload = MrHammadClawProtocol.AnyCodable(payloadMap)
