...
import ai.mrhammadclaw.android.ui.mobileSurface
import ai.mrhammadclaw.android.ui.mobileText
import ai.mrhammadclaw.android.ui.mobileTextSecondary
import ai.mrhammadclaw.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.mrhammadclaw.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.mrhammadclaw.android.ui.mobileFontFamily,
