...
import ai.mrhammadclaw.android.voice.VoiceConversationRole
  ...
  Row(
    ...
    Surface(
      ...
      Column(
        ...
        Text(
          if (isUser) "You" else "MrHammadClaw",
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("MrHammadClaw is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
