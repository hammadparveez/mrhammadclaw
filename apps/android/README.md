...
```bash
pnpm mrhammadclaw gateway --port 18789 --verbose
```
...
- Canvas web content already supports live reload when loaded from Gateway `__mrhammadclaw__/canvas/` (see `docs/platforms/android.md`).
