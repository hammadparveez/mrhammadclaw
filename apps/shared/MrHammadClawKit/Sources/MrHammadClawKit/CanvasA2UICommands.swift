...
public enum MrHammadClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct MrHammadClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct MrHammadClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
