...
@MainActor
public struct MrHammadClawChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: MrHammadClawChatViewModel
    ...
    public init(
        viewModel: MrHammadClawChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                MrHammadClawChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [MrHammadClawChatMessage] {
        let base: [MrHammadClawChatMessage]
    ...
    private func mergeToolResults(in messages: [MrHammadClawChatMessage]) -> [MrHammadClawChatMessage] {
        ...
        for message in messages {
            ...
            let merged = MrHammadClawChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: MrHammadClawChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: MrHammadClawChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: MrHammadClawChatMessage) -> String {
